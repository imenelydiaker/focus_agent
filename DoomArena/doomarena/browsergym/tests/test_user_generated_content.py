...
import doomarena.browsergym.attacks  # noqa: F401 - registers browsergym attacks
...
class RedditCommentTask(AbstractBrowserTask):
    ...
    def setup(self, page) -> Tuple[str, Dict]:
        ...
        page.goto(
            f"{webarena_base_url}:9999/f/allentown/80621/has-anyone-taken-the-greyhound-from-ny-to-allentown"
        )
...
dummy_attack_config_base = AttackConfig(
    ...
    filter=FilterByUrl(allowed_urls=[f"{webarena_base_url}:9999"]),
