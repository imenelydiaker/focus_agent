...
class BM25SRetriever:
    ...
    def __init__(
        self,
        tree: str,
        bm25_args: BM25RetrieverArgs,
    ):
        self.chunk_size = bm25_args.chunk_size
        self.overlap = bm25_args.overlap
        self.top_k = bm25_args.top_k
        self.use_recursive_text_splitter = bm25_args.use_recursive_text_splitter
        corpus = get_chunks_from_tokenizer(tree, self.chunk_size, self.overlap)
